...
public enum PermissionGroup {
    ...
    SPECIAL(31, "&5&lСпец. персона", "&5&lSPECIAL ", '1'),
    TESTER(35, "&e&lТестер", "&e&lTESTER ", '5'),
    BUILDER(35, "&6&lСтроитель", "&6&lBUILD ", '5'),
    SENIOR_BUILDER(36, "&6&lСт. Строитель", "&6&lSr. BUILD ", '4'),
    HELPER(38, "&a&lМл. Модератор", "&a&lJr. MOD ", '5'),
    MODERATOR(39, "&a&lМодератор", "&a&lMOD ", '4'),
    SENIOR_MODERATOR(40, "&2&lСт. Модератор", "&2&lSr. MOD ", '3'),
    GAME_DESIGN(43, "&3&lГейм Дизайнер", "&3&lGAME DESIGN ", '3'),
